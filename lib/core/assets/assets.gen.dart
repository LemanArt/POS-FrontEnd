...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/serverkey.png
  AssetGenImage get serverkey =>
      const AssetGenImage('assets/images/serverkey.png');

  /// File path: assets/images/synclogo.png
  AssetGenImage get synclogo =>
      const AssetGenImage('assets/images/synclogo.png');
